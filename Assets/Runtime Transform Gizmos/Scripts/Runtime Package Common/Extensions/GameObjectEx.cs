...
namespace RTG
{
    public static class GameObjectEx
    {
        ...
        public static bool IsSceneObject(this GameObject gameObject)
        {
            bool result = false;
#if UNITY_EDITOR
            PrefabAssetType prefabAssetType = PrefabAssetType.Regular;
            prefabAssetType = PrefabUtility.GetPrefabAssetType(gameObject);
            result = prefabAssetType == PrefabAssetType.NotAPrefab;
#endif
            return result;
        }
