...
namespace RTG
{
    ...
    public class Hotkeys
    {
        ...
        public bool IsActive(bool checkForOverlaps = true)
        {
            ...
            if (Key != KeyCode.None && !RTInput.GetKey(Key)) return false;
            ...
            if (_lCtrl && !RTInput.GetKey(KeyCode.LeftControl)) return false;
            if (_lCmd && !RTInput.GetKey(KeyCode.LeftCommand)) return false;
            if (_lAlt && !RTInput.GetKey(KeyCode.LeftAlt)) return false;
            if (_lShift && !RTInput.GetKey(KeyCode.LeftShift)) return false;
        ...
        public bool IsActiveInFrame(bool checkForOverlaps = true)
        {
            ...
            if (Key != KeyCode.None && !RTInput.GetKeyDown(Key)) return false;
            ...
            // Check if the corresponding mouse buttons are pressed
            if (_lMouseBtn && !RTInput.GetMouseButtonDown(0)) return false;
            if (_rMouseBtn && !RTInput.GetMouseButtonDown(1)) return false;
            if (_mMouseBtn && !RTInput.GetMouseButtonDown(2)) return false;
        ...
        {
            if (RTInput.GetKey(KeyCode.LeftControl)) return true;
            if (RTInput.GetKey(KeyCode.LeftCommand)) return true;
            if (RTInput.GetKey(KeyCode.LeftAlt)) return true;
            if (RTInput.GetKey(KeyCode.LeftShift)) return true;
