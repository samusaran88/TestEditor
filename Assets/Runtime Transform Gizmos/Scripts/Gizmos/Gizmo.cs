...
namespace RTG
{
    ...
    public class Gizmo
    {
        ...
        public void UpdateHandleHoverInfo_SystemCall(GizmoHoverInfo hoverInfo)
        {
            ...
            {
                PreHoverExit?.Invoke(this, prevHoveredHandleId);
                ...
                PostHoverExit?.Invoke(this, prevHoveredHandleId);
            }
            else if (!wasHovered && _hoverInfo.IsHovered)
            {
                PreHoverEnter?.Invoke(this, _hoverInfo.HandleId);
                foreach (var behaviour in _behaviours)
                {
                    if (behaviour.IsEnabled)
                        behaviour.OnGizmoHoverEnter(_hoverInfo.HandleId);
                }
                PostHoverEnter?.Invoke(this, _hoverInfo.HandleId);
            }
            else
            if (wasHovered && _hoverInfo.IsHovered)
            {
        ...
        public void Render_SystemCall(Camera camera, Plane[] worldFrustumPlanes)
        {
            ...
            if (SceneGizmo == null && isSceneGizmoCamera) 
                return;
            else if (SceneGizmo != null && !isSceneGizmoCamera) 
                return;
        ...
        private void OnInputDevicePickButtonDown()
        {
            ...
            PreHandlePicked?.Invoke(this, _hoveredHandle.Id);
            foreach (var behaviour in _behaviours)
            {
                if (behaviour.IsEnabled)
                    behaviour.OnGizmoHandlePicked(_hoveredHandle.Id);
            }
            PostHandlePicked?.Invoke(this, _hoveredHandle.Id);
        ...
        private void EndDragSession()
        {
            if (_activeDragSession != null)
            {
                ...
                PreDragEnd?.Invoke(this, _dragInfo.HandleId);
                foreach (var behaviour in _behaviours)
                ...
                PostDragEnd?.Invoke(this, dragHandleId);
            }
        ...
        private void OnInputDeviceMoved()
        {
            ...
            if (!_activeDragSession.IsActive)
                return;
            ...
            PreDragUpdate?.Invoke(this, _dragInfo.HandleId);
            ...
            PostDragUpdate?.Invoke(this, _dragInfo.HandleId);
        }
        ...
        private void TryActivateDragSession()
        {
            ...
            if (_hoveredHandle.DragSession == null)
                return;
            ...
            PreDragBeginAttempt?.Invoke(this, _hoveredHandle.Id);
            foreach (var behaviour in _behaviours)
            {
                if (behaviour.IsEnabled)
            ...
            PostDragBeginAttempt?.Invoke(this, _hoveredHandle.Id);
            ...
            PreDragBegin?.Invoke(this, _dragInfo.HandleId);
            foreach (var behaviour in _behaviours)
            {
                if (behaviour.IsEnabled)
                {
            ...
            PostDragBegin?.Invoke(this, _dragInfo.HandleId);
        }
    }
}
